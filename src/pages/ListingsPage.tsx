...
import { FirebaseGetItemById } from '../firebase/Firebase'
    ...
    <>
     { isLoading && data!=={} as DocumentData ?
       <div className=' bg-green-100 min-h-screen py-[75px]  h-fit'>
          ...
          <div className=' grid grid-cols-1 lg:grid-cols-2 mx-20 my-6 gap-8 p-6 shadow-2xl bg-white rounded-lg h-fit lg:h-[580px]'>
